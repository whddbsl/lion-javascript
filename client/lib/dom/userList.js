...
function createSpinner(size = 100, loadingMessage = '유저 정버를 가져오는 중...'){
    return /* html */`
...
export function createEmptyCard(size=200, errorMessage='알 수 없는 오류가 발생했습니다.'){
    return /* html */ `
...
export function renderSnipper(target){
